...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_manuel_arbre_binaire" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#dd718b13#;
   pragma Export (C, u00001, "test_manuel_arbre_binaireB");
   ...
   u00134 : constant Version_32 := 16#e8f5f791#;
   pragma Export (C, u00134, "arbre_binB");
   u00135 : constant Version_32 := 16#c40024bc#;
   pragma Export (C, u00135, "arbre_binS");
